export const CONFIG = {
  payment: {
    ...
    host: process.env.PAYMENT_HOST ?? "http://127.0.0.1:3001/balance/reserve",
  },
  stock: {
    //host: "http://127.0.0.1:3002/products/reserve",
    //host: "http://stock-service.default.svc.cluster.local/products/reserve",
    host: process.env.STOCK_HOST ?? "http://127.0.0.1:3002/products/reserve",
  },
  delivery: {
    //host: "http://127.0.0.1:3003/courier/reserve",
    //  host: "http://delivery-service.default.svc.cluster.local/courier/reserve",
    host: process.env.DELIVERY_HOST ?? "http://127.0.0.1:3003/courier/reserve",
  },
  notify: {
    //host: "http://127.0.0.1:3004/message/send",
    host: process.env.NOTIFY_HOST ?? "http://127.0.0.1:3004/message/send",
  },
  trace: false
}
